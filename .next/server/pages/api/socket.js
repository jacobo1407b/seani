...
module.exports = __webpack_require__("Gk+j");
...
/* harmony import */ var _utils_firebase__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("s7pt");
/* harmony import */ var _utils_variables__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("Appm");
    ...
    io.on('connection', socket => {
      socket.on('message', data => {
        ...
        async function update() {
          await _utils_firebase__WEBPACK_IMPORTED_MODULE_1__[/* db */ "c"].doc(`${_utils_variables__WEBPACK_IMPORTED_MODULE_2__[/* collection */ "a"]}/${id}`).update({
            time: time
          });
        }
