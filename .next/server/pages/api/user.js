...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  try {
    ...
    const data = await _utils_firebase__WEBPACK_IMPORTED_MODULE_0__[/* db */ "c"].collection(_utils_variables__WEBPACK_IMPORTED_MODULE_1__[/* collection */ "a"]).where("user", "==", req.body.uid).get();
    const infoUser = (data === null || data === void 0 ? void 0 : (_data$docs$ = data.docs[0]) === null || _data$docs$ === void 0 ? void 0 : _data$docs$.data()) || null;
    res.status(200).json({
      error: false,
      data: infoUser
    });
