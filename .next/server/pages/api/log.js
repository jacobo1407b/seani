...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  try {
    const login = await _utils_firebase__WEBPACK_IMPORTED_MODULE_0__[/* auth */ "b"].signInWithEmailAndPassword(req.body.email, req.body.password); //res.cookie('user',login)
