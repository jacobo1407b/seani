...
module.exports = __webpack_require__("L9mx");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  try {
    const time = await _utils_firebase__WEBPACK_IMPORTED_MODULE_0__[/* db */ "c"].doc(`${_utils_variables__WEBPACK_IMPORTED_MODULE_1__[/* collection */ "a"]}/${uid}`).update({
      activeLengua: false,
      activeMat: false,
      activeLogic: false,
      activeExam1: false,
